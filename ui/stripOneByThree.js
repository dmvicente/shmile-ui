...
StripOneByThree.prototype.render = function() {
    ...
    this.frameDim = {
        w: _frame_w, //(this.compositeDim.w - (2*this.photoBorder)),
...
StripOneByThree.prototype.toString = function() {
    ret = [];
   ...
   */
  StripOneByThree.prototype.updatePhotoSet = function(img_src, idx, cb) {
    var view = this;
   ...
   */
  StripOneByThree.prototype.zoomFrame = function(idx, dir, state, onfinish) {
      var view = this;
...
StripOneByThree.prototype.createOverlayImage = function(overlayImage) {
